...
//                                             Delete
//                                         </button>
//                                         <h2 className='text-xl font-semibold line-clamp-1'>{product?.productId?.productName}</h2>
...
//                                             <p className='text-gray-800 font-semibold text-lg'>${(product?.productId?.sellingPrice * product?.quantity).toFixed(2)}</p>
//                                         </div>
...
//                                 <button className='bg-blue-600 p-2 text-white w-full mt-4 rounded-lg hover:bg-blue-700'>Proceed to Checkout</button>
