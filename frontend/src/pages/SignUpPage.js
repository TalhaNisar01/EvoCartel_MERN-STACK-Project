...
const SignUpPage = () => {
  ...
  const [passwordGuidelines, setPasswordGuidelines] = useState(""); // State for password guidelines
  const navigate = useNavigate();
  ...
  const handleOnChange = (e) => {
    ...
    if (name === "password") {
      ...
      setPasswordGuidelines(feedback.suggestions.join(' ')); // Update guidelines based on feedback
    }
  };
